...
# --------------------------
model_path = os.path.join("model", "best_region_model.pkl")
encoder_path = os.path.join("model", "region_encoder_cv.pkl")
...
final_csv_path = os.path.join("predict", "test_predictions_cv.csv")
final_report_path = os.path.join("predict", "test_predictions_report_cv.txt")
